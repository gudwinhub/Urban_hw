...
class Table:
    ...
    def __init__(self, amount_table):
        ...
        self.tables = {key: False for key in range(1, amount_table+1)} # генерим свободные столики
        print(self.tables)
